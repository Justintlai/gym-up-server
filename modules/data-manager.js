                ...
                include: [
                    {
                        ...
                        attributes: ["id", "workoutId", "reps", "weight"],
                        required: true
                    },
                    {
                        model: models.User,
        ...
        .then(function(session) {
            if (session) {
                ...
                if (newData.sessionName)
                    session.sessionName = newData.sessionName;
...
exports.updateSessionDetail = function(
    userId,
    sessionDetailId,
    newData,
    callback
    ...
    models.sessionDetail
        ...
        .then(function(session) {
            if (session) {
                ...
                if (newData.workoutOrder)
                    session.workoutOrder = newData.workoutOrder;
